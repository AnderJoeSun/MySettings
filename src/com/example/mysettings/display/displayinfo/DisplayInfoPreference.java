...
package me.zhengnian.mysettings.display.displayinfo;
...
public class DisplayInfoPreference extends DialogPreference {


	public DisplayInfoPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
